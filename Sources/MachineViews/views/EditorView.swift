        ...
        VStack {
            ...
            HStack {
                GeometryReader{ reader in
                    CollapsableAttributeGroupsView(machine: machineViewModel.$machine.asBinding, path: Machine.path.attributes, label: "Dependencies", collapsed: Binding(get: {viewModel.leftPaneCollapsed}, set: {viewModel.leftPaneCollapsed = $0}), collapseLeft: true, buttonSize: 20, buttonWidth: viewModel.buttonWidth, buttonHeight: viewModel.buttonWidth)
                    ...
                    FocusedAttributesView(machine: machineViewModel.$machine.asBinding, viewType: $viewModel.focusedView, label: "Attributes", collapsed: Binding(get: { viewModel.rightPaneCollapsed }, set: { viewModel.rightPaneCollapsed = $0 }), collapseLeft: false, buttonSize: 20.0, buttonWidth: viewModel.buttonWidth, buttonHeight: viewModel.buttonWidth)
